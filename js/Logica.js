...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "project-pc-title": "Morales Development",
            "project-pc-desc": "Aplicación de escritorio integral para PC orientada a la gestión de datos empresariales, control de procesos y administración estructurada. Desarrollada con arquitectura por capas, persistencia en SQL Server y optimización de rendimiento local.",
        ...
        en: {
            ...
            "project-pc-title": "Morales Development",
            "project-pc-desc": "Comprehensive desktop application for PC designed for enterprise data management, process control, and structured administration. Built with layered architecture, SQL Server persistence, and local performance optimization.",
